...
print("Starting cross-validation round 2")

with open("mbtr_train_2.pkl", "rb") as f1, open("mbtr_val_2.pkl", "rb") as f2, open("homo_train_2.pkl", "rb") as f3, open("homo_val_2.pkl", "rb") as f4:
...
print("Time for cross-validation loop 2 (KRR):", cv_time)
timefile = open("cv_time_2.txt", "w")
