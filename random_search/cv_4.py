...
print("Starting cross-validation round 4")

with open("mbtr_train_4.pkl", "rb") as f1, open("mbtr_val_4.pkl", "rb") as f2, open("homo_train_4.pkl", "rb") as f3, open("homo_val_4.pkl", "rb") as f4:
...
print("Time for cross-validation loop 4 (KRR):", cv_time)
timefile = open("cv_time_4.txt", "w")
